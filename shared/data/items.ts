...
export const ITEMS: Item[] = [
  // ── 소비 아이템 ──
  {
    ...
    type: 'consumable', rarity: 'common', iconUrl: '/assets/items/hp_potion_small.png',
  ...
  },
  {
    ...
    type: 'consumable', rarity: 'uncommon', iconUrl: '/assets/items/hp_potion_medium.png',
  ...
  },
  {
    ...
    type: 'consumable', rarity: 'common', iconUrl: '/assets/items/mp_potion_small.png',
  ...
  // ── 장비 아이템 ──
  {
    ...
    type: 'weapon', rarity: 'common', iconUrl: '/assets/items/iron_sword.png',
    stackable: false, maxStack: 1, sellPrice: 30,
    stats: { attack: 10 },
  },
  {
    id: 'shadow_blade', name: '그림자 단검', description: '어둠의 기운이 서린 날카로운 단검.',
    type: 'weapon', rarity: 'rare', iconUrl: '/assets/items/shadow_blade.png',
  ...
  },
  {
    ...
    type: 'armor', rarity: 'common', iconUrl: '/assets/items/leather_armor.png',
    stackable: false, maxStack: 1, sellPrice: 40,
    stats: { defense: 8, hp: 20 },
  },
  {
    id: 'bone_ring', name: '뼈의 반지', description: '망자의 뼈로 만든 저주받은 반지.',
    type: 'accessory', rarity: 'uncommon', iconUrl: '/assets/items/bone_ring.png',
