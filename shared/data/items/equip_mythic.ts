...
export const EQUIP_MYTHIC: Item[] = [
  ...
  // ══════════════════════════════════════════════
  {
    ...
    stats: { attack: 700, defense: 100, critRate: 0.10, critDamage: 0.4 },
    procEffect: { chance: 0.2, type: 'def_boost', value: 200, duration: 3, cooldown: 10, description: '20% 확률: 방어력 200% 증가 (3턴, 쿨 10턴)' },
  },
  {
  ...
  },
  {
    ...
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'dark_knight', setId: 'set_myth_dk',
    stats: { attack: 250, defense: 250, critRate: 0.08, critDamage: 0.3 },
  },
  {
  ...
  },
  {
    ...
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'dark_knight', setId: 'set_myth_dk',
    stats: { defense: 400, hp: 1200, mp: 200, critRate: 0.07 },
    procEffect: { chance: 0.15, type: 'heal_burst', value: 20, duration: 1, cooldown: 6, description: '15% 확률: HP 20% 즉시 회복 (쿨 6턴)' },
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    stats: { attack: 950, critRate: 0.12, critDamage: 0.6, mp: 100 },
    procEffect: { chance: 0.15, type: 'extra_damage', value: 300, duration: 1, cooldown: 8, description: '15% 확률: 다음 공격 300% 추가 피해 (쿨 8턴)' },
  },
  {
  ...
  },
  {
    ...
    type: 'gloves', rarity: 'mythic', iconUrl: '/assets/items/myth_gloves.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'shadow_mage', setId: 'set_myth_sm',
    stats: { attack: 350, critRate: 0.10, critDamage: 0.5, mp: 250 },
  },
  {
  ...
  },
  {
    ...
    type: 'accessory', rarity: 'mythic', iconUrl: '/assets/items/myth_accessory.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'shadow_mage', setId: 'set_myth_sm',
    stats: { attack: 750, critRate: 0.08, critDamage: 0.5, mp: 300 },
    procEffect: { chance: 0.2, type: 'atk_boost', value: 150, duration: 3, cooldown: 10, description: '20% 확률: 공격력 150% 증가 (3턴, 쿨 10턴)' },
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    stats: { attack: 850, critRate: 0.15, critDamage: 0.7, speed: 12 },
    procEffect: { chance: 0.25, type: 'crit_boost', value: 100, duration: 3, cooldown: 10, description: '25% 확률: 치명타율 100% 증가 (3턴, 쿨 10턴)' },
  },
  {
    ...
    type: 'offhand', rarity: 'mythic', iconUrl: '/assets/items/myth_offhand.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'hunter', setId: 'set_myth_hn',
    stats: { attack: 500, speed: 15, defense: 150, hp: 200 },
  },
  {
    ...
    type: 'helm', rarity: 'mythic', iconUrl: '/assets/items/myth_helm.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'hunter', setId: 'set_myth_hn',
    stats: { defense: 350, hp: 700, speed: 14, attack: 100 },
  },
  {
    ...
    type: 'shoulders', rarity: 'mythic', iconUrl: '/assets/items/myth_shoulders.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'hunter', setId: 'set_myth_hn',
    stats: { attack: 350, speed: 18, defense: 200, hp: 200 },
  },
  {
    ...
    type: 'chest', rarity: 'mythic', iconUrl: '/assets/items/myth_chest.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'hunter', setId: 'set_myth_hn',
    stats: { defense: 400, hp: 1000, speed: 5, attack: 150 },
  },
  {
  ...
  },
  {
    ...
    type: 'gloves', rarity: 'mythic', iconUrl: '/assets/items/myth_gloves.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'hunter', setId: 'set_myth_hn',
    stats: { attack: 400, critRate: 0.12, critDamage: 0.5, speed: 10 },
  },
  {
    ...
    type: 'belt', rarity: 'mythic', iconUrl: '/assets/items/myth_belt.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'hunter', setId: 'set_myth_hn',
    stats: { defense: 250, hp: 500, attack: 100, speed: 12 },
  },
  {
    ...
    type: 'boots', rarity: 'mythic', iconUrl: '/assets/items/myth_boots.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'hunter', setId: 'set_myth_hn',
    stats: { speed: 35, defense: 250, hp: 400, attack: 100 },
  },
  {
    ...
    type: 'accessory', rarity: 'mythic', iconUrl: '/assets/items/myth_accessory.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'hunter', setId: 'set_myth_hn',
    stats: { attack: 500, critRate: 0.13, critDamage: 0.7, speed: 18 },
    procEffect: { chance: 0.2, type: 'speed_boost', value: 100, duration: 3, cooldown: 10, description: '20% 확률: 속도 100% 증가 (3턴, 쿨 10턴)' },
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    stats: { attack: 500, hp: 600, mp: 250, critRate: 0.05 },
    procEffect: { chance: 0.2, type: 'heal_burst', value: 30, duration: 1, cooldown: 8, description: '20% 확률: HP 30% 즉시 회복 (쿨 8턴)' },
  },
  {
  ...
  },
  {
    ...
    type: 'gloves', rarity: 'mythic', iconUrl: '/assets/items/myth_gloves.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'priest', setId: 'set_myth_pr',
    stats: { attack: 250, hp: 600, mp: 250, critRate: 0.05 },
  },
  {
  ...
  },
  {
    ...
    type: 'accessory', rarity: 'mythic', iconUrl: '/assets/items/myth_accessory.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'priest', setId: 'set_myth_pr',
    stats: { hp: 900, mp: 450, defense: 350, critRate: 0.10 },
    procEffect: { chance: 0.25, type: 'def_boost', value: 150, duration: 3, cooldown: 8, description: '25% 확률: 방어력 150% 증가 (3턴, 쿨 8턴)' },
  },
  ...
  // ══════════════════════════════════════════════
  {
    ...
    stats: { attack: 1000, critRate: 0.15, critDamage: 0.8, speed: 8 },
    procEffect: { chance: 0.2, type: 'atk_boost', value: 200, duration: 3, cooldown: 10, description: '20% 확률: 공격력 200% 증가 (3턴, 쿨 10턴)' },
  },
  {
    ...
    type: 'offhand', rarity: 'mythic', iconUrl: '/assets/items/myth_offhand.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'assassin', setId: 'set_myth_as',
    stats: { attack: 600, critRate: 0.05, critDamage: 0.4, speed: 12 },
  },
  {
    ...
    type: 'helm', rarity: 'mythic', iconUrl: '/assets/items/myth_helm.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'assassin', setId: 'set_myth_as',
    stats: { defense: 200, hp: 450, speed: 15, attack: 150 },
  },
  {
    ...
    type: 'shoulders', rarity: 'mythic', iconUrl: '/assets/items/myth_shoulders.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'assassin', setId: 'set_myth_as',
    stats: { attack: 350, speed: 18, defense: 150, hp: 200 },
  },
  {
    ...
    type: 'chest', rarity: 'mythic', iconUrl: '/assets/items/myth_chest.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'assassin', setId: 'set_myth_as',
    stats: { defense: 250, hp: 600, attack: 350, speed: 5 },
  },
  {
  ...
  },
  {
    ...
    type: 'gloves', rarity: 'mythic', iconUrl: '/assets/items/myth_gloves.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'assassin', setId: 'set_myth_as',
    stats: { attack: 550, critRate: 0.12, critDamage: 0.6, speed: 8 },
  },
  {
  ...
  },
  {
    ...
    type: 'boots', rarity: 'mythic', iconUrl: '/assets/items/myth_boots.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'assassin', setId: 'set_myth_as',
    stats: { speed: 40, attack: 300, hp: 300, defense: 100 },
  },
  {
    ...
    type: 'accessory', rarity: 'mythic', iconUrl: '/assets/items/myth_accessory.svg',
    stackable: false, maxStack: 1, sellPrice: 200000, requiredClass: 'assassin', setId: 'set_myth_as',
    stats: { attack: 700, critRate: 0.13, critDamage: 0.8, speed: 15 },
    procEffect: { chance: 0.15, type: 'extra_damage', value: 250, duration: 1, cooldown: 6, description: '15% 확률: 다음 공격 250% 추가 피해 (쿨 6턴)' },
  },
];
